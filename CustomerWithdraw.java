...
public class CustomerWithdraw extends JFrame{
	JLabel l1,l2;
	JTextField t;
	JButton b1,b2; 
	int C;
	public CustomerWithdraw(int CID) {
		C=CID;
        	  ...
        	  public void actionPerformed (ActionEvent e){
        		  ...
        		  if(e.getSource()==b2) {
        			  int amount=Integer.parseInt(t.getText());
        				  dispose();
        				  try {
							CustomerWithdrawDao.updateBalance(C,amount);
						} catch (Exception e1) {
	...
	public static void lain(int CID) {
		CustomerWithdraw E =new CustomerWithdraw(CID);
		E.setSize(400, 400);
		E.setVisible(true);
