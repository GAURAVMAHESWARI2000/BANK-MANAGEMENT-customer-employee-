...
public class UpdateDOB extends JFrame{
	JLabel l1,l2,l3;
	JTextField t1,t2;
	JButton b1,b2; 
	public UpdateDOB() {
		l1=new JLabel("UPDATE DOB");
		l2=new JLabel("ENTER CUSTOMERID WHOSE DATA TO BE UPDATED");
		l3=new JLabel("ENTER NEW DOB");
  	...
  	class myhandler implements ActionListener{
        	  public void actionPerformed (ActionEvent e) {
        		  ...
        		  if(e.getSource()==b2) {
        			  ...
        			  try {
						UpdateInformationDao.updateDOB(value,CID);
					} catch (Exception e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
        			  JOptionPane.showMessageDialog(null,"DOB UPDATED SUCCESSFULLY");
