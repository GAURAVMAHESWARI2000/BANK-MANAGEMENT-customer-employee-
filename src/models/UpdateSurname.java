...
public class UpdateSurname extends JFrame{
	JLabel l1,l2,l3;
	JTextField t1,t2;
	JButton b1,b2; 
	public UpdateSurname() {
		l1=new JLabel("UPDATE SURNAME");
		l2=new JLabel("ENTER CUSTOMERID WHOSE DATA TO BE UPDATED");
		l3=new JLabel("ENTER NEW SURNAME");
  	...
  	class myhandler implements ActionListener{
        	  public void actionPerformed (ActionEvent e) {
        		  ...
        		  if(e.getSource()==b2) {
        			  ...
        			  try {
						UpdateInformationDao.updateSurname(value,CID);
					} catch (Exception e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
        			  JOptionPane.showMessageDialog(null,"SURNAME UPDATED SUCCESSFULLY");
	...
	public static void main(String [] args) {
		UpdateSurname E =new UpdateSurname();
		E.setSize(400,200);
		E.setVisible(true);
