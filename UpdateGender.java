...
public class UpdateGender extends JFrame{
	JLabel l1,l2,l3;
	JTextField t1,t2;
	JButton b1,b2; 
	public UpdateGender() {
		l1=new JLabel("UPDATE GENDER");
		l2=new JLabel("ENTER CUSTOMERID WHOSE DATA TO BE UPDATED");
		l3=new JLabel("ENTER NEW GENDER");
  	...
  	class myhandler implements ActionListener{
        	  public void actionPerformed (ActionEvent e) {
        		  ...
        		  if(e.getSource()==b2) {
        			  ...
        			  try {
						UpdateInformationDao.updateGender(value,CID);
					} catch (Exception e1) {
	...
	public static void main(String [] args) {
		UpdateGender E =new UpdateGender();
		E.setSize(400,200);
		E.setVisible(true);
